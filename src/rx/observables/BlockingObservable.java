...
public final class BlockingObservable<T>
{
  ...
  public void forEach(Action1<? super T> paramAction1)
  {
    ...
    BlockingUtils.awaitForComplete(localCountDownLatch, o.subscribe(new BlockingObservable.1(this, localCountDownLatch, localAtomicReference, paramAction1)));
  ...
  public void subscribe()
  {
    ...
    BlockingUtils.awaitForComplete(localCountDownLatch, o.subscribe(new BlockingObservable.4(this, arrayOfThrowable, localCountDownLatch)));
  ...
  public void subscribe(Observer<? super T> paramObserver)
  {
    ...
    Subscription localSubscription = o.subscribe(new BlockingObservable.5(this, localLinkedBlockingQueue, localNotificationLite));
    try
    {
      boolean bool;
      do
