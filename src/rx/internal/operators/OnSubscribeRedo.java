  ...
  implements Observable.OnSubscribe<T>
{
  ...
  public void call(Subscriber<? super T> paramSubscriber)
  {
    ...
    localWorker.schedule(new OnSubscribeRedo.4(this, (Observable)controlHandlerFunction.call(localBehaviorSubject.lift(new OnSubscribeRedo.3(this))), paramSubscriber, localAtomicLong, localWorker, (Action0)localObject, localAtomicBoolean));
