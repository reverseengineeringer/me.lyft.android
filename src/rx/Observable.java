...
public class Observable<T>
{
  ...
  {
    return from(Arrays.asList(new Object[] { paramT1, paramT2, paramT3, paramT4, paramT5, paramT6, paramT7, paramT8, paramT9 }));
  }
  ...
  {
    return from(Arrays.asList(new Object[] { paramT1, paramT2, paramT3, paramT4, paramT5, paramT6, paramT7, paramT8, paramT9, paramT10 }));
  }
  ...
  {
    return merge(from(Arrays.asList(new Observable[] { paramObservable1, paramObservable2 })));
  }
  ...
  {
    return merge(from(Arrays.asList(new Observable[] { paramObservable1, paramObservable2, paramObservable3 })));
  }
  ...
  {
    return merge(from(Arrays.asList(new Observable[] { paramObservable1, paramObservable2, paramObservable3, paramObservable4 })));
  }
  ...
  {
    return merge(from(Arrays.asList(new Observable[] { paramObservable1, paramObservable2, paramObservable3, paramObservable4, paramObservable5 })));
  }
  ...
  {
    return merge(from(Arrays.asList(new Observable[] { paramObservable1, paramObservable2, paramObservable3, paramObservable4, paramObservable5, paramObservable6 })));
  }
  
  public static final <T> Observable<T> merge(Observable<? extends T> paramObservable1, Observable<? extends T> paramObservable2, Observable<? extends T> paramObservable3, Observable<? extends T> paramObservable4, Observable<? extends T> paramObservable5, Observable<? extends T> paramObservable6, Observable<? extends T> paramObservable7)
  {
    return merge(from(Arrays.asList(new Observable[] { paramObservable1, paramObservable2, paramObservable3, paramObservable4, paramObservable5, paramObservable6, paramObservable7 })));
  }
  
  public static final <T> Observable<T> merge(Observable<? extends T> paramObservable1, Observable<? extends T> paramObservable2, Observable<? extends T> paramObservable3, Observable<? extends T> paramObservable4, Observable<? extends T> paramObservable5, Observable<? extends T> paramObservable6, Observable<? extends T> paramObservable7, Observable<? extends T> paramObservable8)
  {
    return merge(from(Arrays.asList(new Observable[] { paramObservable1, paramObservable2, paramObservable3, paramObservable4, paramObservable5, paramObservable6, paramObservable7, paramObservable8 })));
  }
  
  public static final <T> Observable<T> merge(Observable<? extends T> paramObservable1, Observable<? extends T> paramObservable2, Observable<? extends T> paramObservable3, Observable<? extends T> paramObservable4, Observable<? extends T> paramObservable5, Observable<? extends T> paramObservable6, Observable<? extends T> paramObservable7, Observable<? extends T> paramObservable8, Observable<? extends T> paramObservable9)
  {
    return merge(from(Arrays.asList(new Observable[] { paramObservable1, paramObservable2, paramObservable3, paramObservable4, paramObservable5, paramObservable6, paramObservable7, paramObservable8, paramObservable9 })));
  }
  ...
  private static <T> Subscription subscribe(Subscriber<? super T> paramSubscriber, Observable<T> paramObservable)
  {
    ...
    try
    {
      hook.onSubscribeStart(paramObservable, onSubscribe).call(localObject);
  ...
  {
    (R)paramFunc1.call(new OnSubscribe()
    {
      public void call(Subscriber<? super T> paramAnonymousSubscriber)
      {
        paramAnonymousSubscriber.add(Observable.subscribe(paramAnonymousSubscriber, Observable.this));
      }
    });
  }
  ...
  public final Observable<T> repeatWhen(final Func1<? super Observable<? extends Void>, ? extends Observable<?>> paramFunc1)
  {
    OnSubscribeRedo.repeat(this, new Func1()
    {
      ...
      {
        return (Observable)paramFunc1.call(paramAnonymousObservable.map(new Observable.15.1(this)));
      }
    });
  }
  ...
  public final Observable<T> repeatWhen(final Func1<? super Observable<? extends Void>, ? extends Observable<?>> paramFunc1, Scheduler paramScheduler)
  {
    OnSubscribeRedo.repeat(this, new Func1()
    {
      public Observable<?> call(Observable<? extends Notification<?>> paramAnonymousObservable)
      {
        return (Observable)paramFunc1.call(paramAnonymousObservable.map(new Observable.14.1(this)));
      }
    }, paramScheduler);
  }
  ...
  {
    OperatorReplay.multicastSelector(new Func0()
    {
  ...
  public final <R> Observable<R> replay(Func1<? super Observable<T>, ? extends Observable<R>> paramFunc1, final int paramInt, final long paramLong, TimeUnit paramTimeUnit, final Scheduler paramScheduler)
  {
    ...
    OperatorReplay.multicastSelector(new Func0()
    {
      public ConnectableObservable<T> call()
      {
        return replay(paramInt, paramLong, paramScheduler, val$scheduler);
      }
    }, paramFunc1);
  }
  
  public final <R> Observable<R> replay(final Func1<? super Observable<T>, ? extends Observable<R>> paramFunc1, final int paramInt, final Scheduler paramScheduler)
  {
    OperatorReplay.multicastSelector(new Func0()new Func1
    {
      public ConnectableObservable<T> call()
      {
        return replay(paramInt);
    ...
    {
      public Observable<R> call(Observable<T> paramAnonymousObservable)
      {
        return ((Observable)paramFunc1.call(paramAnonymousObservable)).observeOn(paramScheduler);
      }
    });
  }
  ...
  public final <R> Observable<R> replay(Func1<? super Observable<T>, ? extends Observable<R>> paramFunc1, final long paramLong, TimeUnit paramTimeUnit, final Scheduler paramScheduler)
  {
    OperatorReplay.multicastSelector(new Func0()
    {
      public ConnectableObservable<T> call()
      {
        return replay(paramLong, paramScheduler, val$scheduler);
      }
    }, paramFunc1);
  }
  
  public final <R> Observable<R> replay(final Func1<? super Observable<T>, ? extends Observable<R>> paramFunc1, final Scheduler paramScheduler)
  {
    OperatorReplay.multicastSelector(new Func0()new Func1
    {
      public ConnectableObservable<T> call()
  ...
  public final Observable<T> retryWhen(final Func1<? super Observable<? extends Throwable>, ? extends Observable<?>> paramFunc1)
  {
    OnSubscribeRedo.retry(this, new Func1()
    {
      public Observable<?> call(Observable<? extends Notification<?>> paramAnonymousObservable)
      {
        return (Observable)paramFunc1.call(paramAnonymousObservable.map(new Observable.24.1(this)));
      }
    });
  }
  ...
  public final Observable<T> retryWhen(final Func1<? super Observable<? extends Throwable>, ? extends Observable<?>> paramFunc1, Scheduler paramScheduler)
  {
    OnSubscribeRedo.retry(this, new Func1()
    {
      public Observable<?> call(Observable<? extends Notification<?>> paramAnonymousObservable)
      {
        return (Observable)paramFunc1.call(paramAnonymousObservable.map(new Observable.25.1(this)));
      }
    }, paramScheduler);
  }
  ...
  {
    static final Observable<Object> INSTANCE = Observable.create(new Observable.EmptyHolder.1());
  }
