  ...
  implements Sink
{
    ...
    throws IOException
  {
    ...
    FramedStream.access$500(this$0).writeData(FramedStream.access$600(this$0), true, null, 0L);
    label113:
    synchronized (this$0)
    {
      closed = true;
      FramedStream.access$500(this$0).flush();
    ...
    throws IOException
  {
    ...
    synchronized (this$0)
    {
      FramedStream.access$1200(this$0);
      if (sendBuffer.size() > 0L)
      {
        emitDataFrame(false);
        FramedStream.access$500(this$0).flush();
  ...
  {
    return FramedStream.access$1100(this$0);
  }
