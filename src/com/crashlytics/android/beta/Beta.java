  ...
  implements DeviceIdentifierProvider
{
    ...
    for (;;)
    {
      try
      {
        ...
        if (localInputStream != null)
        {
          ...
          localObject2 = localInputStream;
          localObject3 = localInputStream;
          Fabric.getLogger().d("Beta", packageName + " build properties: " + versionName + " (" + versionCode + ")" + " - " + buildId);
        }
  ...
  {
    return (paramBetaSettingsData != null) && (!TextUtils.isEmpty(updateUrl)) && (paramBuildProperties != null);
  }
  ...
  protected Boolean doInBackground()
  {
    ...
    if (canCheckForUpdates(localBetaSettingsData, localBuildProperties)) {
      updatesController.initialize(localContext, this, localIdManager, localBetaSettingsData, localBuildProperties, new PreferenceStoreImpl(this), new SystemCurrentTimeProvider(), new DefaultHttpRequestFactory(Fabric.getLogger()));
    }
  ...
  protected boolean onPreExecute()
  {
    ...
    updatesController = createUpdatesController(Build.VERSION.SDK_INT, localApplication);
    return true;
  }
}
