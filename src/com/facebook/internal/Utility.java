...
public final class Utility
{
  ...
  public static void loadAppSettingsAsync(Context paramContext, final String paramString)
  {
    ...
    FacebookSdk.getExecutor().execute(new Runnable()
    {
      public void run()
      {
        ...
        Object localObject1 = Utility.getAppSettingsQueryResponse(paramString);
        if (localObject1 != null)
        {
          Utility.parseAppSettingsFromJSON(paramString, (JSONObject)localObject1);
    ...
    throws IOException
  {
    ...
    //   2: aconst_null
    //   3: astore_3
    //   4: new 395	java/io/BufferedInputStream
    //   7: dup
    //   8: aload_0
    //   9: invokespecial 398	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   12: astore_0
    //   13: new 1026	java/io/InputStreamReader
    //   16: dup
    //   17: aload_0
    //   18: invokespecial 1027	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   21: astore_2
    //   22: new 304	java/lang/StringBuilder
    //   25: dup
    //   26: invokespecial 305	java/lang/StringBuilder:<init>	()V
    //   29: astore_3
    //   30: sipush 2048
    ...
    //   37: aload_2
    //   38: aload 4
    //   40: invokevirtual 1030	java/io/InputStreamReader:read	([C)I
    //   43: istore_1
    //   44: iload_1
    //   45: iconst_m1
    //   46: if_icmpeq +32 -> 78
    ...
    //   52: iconst_0
    //   53: iload_1
    //   54: invokevirtual 1033	java/lang/StringBuilder:append	([CII)Ljava/lang/StringBuilder;
    //   57: pop
    //   58: goto -21 -> 37
    //   61: astore 4
    //   63: aload_2
    ...
    //   67: astore_2
    //   68: aload_0
    //   69: invokestatic 1035	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   72: aload_3
    //   73: invokestatic 1035	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   76: aload_2
    //   77: athrow
    //   78: aload_3
    //   79: invokevirtual 318	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   82: astore_3
    //   83: aload_0
    //   84: invokestatic 1035	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   87: aload_2
    //   88: invokestatic 1035	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   91: aload_3
    //   92: areturn
    //   93: astore 4
    //   95: aload_2
  ...
  public static class FetchedAppSettings
  {
    ...
    private FetchedAppSettings(boolean paramBoolean1, String paramString, boolean paramBoolean2, boolean paramBoolean3, int paramInt, Map<String, Map<String, Utility.DialogFeatureConfig>> paramMap, FacebookRequestErrorClassification paramFacebookRequestErrorClassification)
    {
