  ...
  implements j
{
  ...
  public o()
  {
    ...
    a.put(cs.Y, "Allow them to link and manage their loyalty card in your PayPal wallet.");
    ...
    a.put(cs.aT, "Send an SMS to your phone. The 6-digit code you receive will be valid for 5 minutes.");
    a.put(cs.aU, "Sending SMS");
    a.put(cs.aV, "Enter the 6-digit security code");
    a.put(cs.aW, "Your mobile number");
    a.put(cs.aX, "Send SMS");
    a.put(cs.aY, "Send SMS Again");
