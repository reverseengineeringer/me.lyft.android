  ...
  implements j
{
  ...
  public u()
  {
    a.put(cs.a, "Accetta e paga");
    a.put(cs.b, "e altri");
    a.put(cs.c, "Autenticazione…");
    a.put(cs.d, "Prec.");
    a.put(cs.e, "Di riserva");
    a.put(cs.f, "Annulla");
    a.put(cs.g, "American Express");
    a.put(cs.h, "Carta Aura");
    a.put(cs.i, "Carta Aurore");
    ...
    a.put(cs.v, "Visa");
    a.put(cs.w, "Modifica metodo di pagamento");
    a.put(cs.x, "Conto corrente");
    a.put(cs.y, "Controllo dispositivo…");
    a.put(cs.z, "Rimuovi dati della carta");
    a.put(cs.A, "Conferma");
    a.put(cs.B, "Rimuovere i dati della carta?");
    a.put(cs.C, "Addebita importo sulla carta");
    a.put(cs.D, "Vuoi uscire da PayPal?");
    a.put(cs.E, "Paga");
    a.put(cs.F, "Accetta");
    a.put(cs.G, "Data creazione conto");
    a.put(cs.H, "Stato del conto");
    a.put(cs.I, "Tipo di conto");
    a.put(cs.J, "Indirizzo");
    a.put(cs.K, "Fascia di età");
    a.put(cs.L, "Data di nascita");
    a.put(cs.M, "Indirizzo email");
    a.put(cs.N, "Nome e cognome");
    a.put(cs.O, "Sesso");
    a.put(cs.P, "Lingua");
    a.put(cs.Q, "Locale");
    a.put(cs.R, "Telefono");
    a.put(cs.S, "Fuso orario");
    a.put(cs.T, "Condividi il seguente: %s.");
    a.put(cs.U, "%s ti chiede di:");
    a.put(cs.V, "Condividi i <a href='%1$s'>metodi di pagamento</a> collegati al tuo conto PayPal.");
    a.put(cs.W, "Per effettuare una scelta, attiva la visualizzazione dei metodi di pagamento.");
    a.put(cs.X, "<a href='%1$s'>Autorizza l’addebito</a> dei prossimi acquisti effettuati su %2$s e pagati con PayPal. Autorizzi PayPal a pagare tutti gli importi richiesti da %3$s.");
    a.put(cs.Y, "consentirgli di aggiungere e gestire la propria carta fedeltà nel tuo portafoglio PayPal.");
    a.put(cs.Z, "Accettare l’<a href='%2$s'></a> Informativa sulla privacy<a href='%3$s'> e le</a> Condizioni d’uso di %1$s.");
    a.put(cs.aa, "Consentirgli di <a href='%1$s'>richiedere denaro</a> a tuo nome fino alla revoca del consenso.");
    a.put(cs.ab, "Consentirgli di <a href='%1$s'>inviare denaro</a> a tuo nome fino alla revoca del consenso.");
    a.put(cs.ac, "Consenso");
    a.put(cs.ad, "Email");
    a.put(cs.ae, "Dati di esempio");
    a.put(cs.af, "Sandbox");
    a.put(cs.ag, "Scadenza");
    a.put(cs.ah, "<h1><strong>Metodi di pagamento</strong></h1><p>PayPal condivide solo i tuoi metodi di pagamento disponibili per l’utilizzo.</p>");
    a.put(cs.ai, "Password dimenticata?");
    a.put(cs.aj, "Da");
    a.put(cs.ak, "Come vuoi pagare i prossimi acquisti su %1$s?");
    a.put(cs.al, "<h1><strong>Consenso ai pagamenti preautorizzati</strong></h1><p>Gli importi dei prossimi pagamenti effettuati con PayPal da questa app verranno prelevati dal tuo metodo di pagamento predefinito.</p><p>Per annullare il consenso, accedi al tuo conto PayPal, seleziona <strong>Profilo</strong> &gt; <strong>Sicurezza</strong> &gt; <strong>Log in con PayPal</strong> e rimuovi il commerciante dall’elenco.</p><p>Si applica la sezione Pagamenti automatici delle <a href='%s'>Condizioni d’uso PayPal</a>.</p><p>Per verificare il funzionamento dell’addebito dei pagamenti futuri sul tuo conto PayPal, questa app potrebbe simulare una transazione di prova, senza un reale trasferimento di denaro.</p>");
    a.put(cs.am, "Errore interno");
    a.put(cs.an, "<p>Cliccando il pulsante di seguito, accetto le <a href='%1$s'>Condizioni d’uso PayPal</a> e dichiaro di rispettare le leggi e normative del Giappone, tra cui le sanzioni previste per i pagamenti alla Corea del Nord e all’Iran in base al <a href='%2$s'>Foreign Exchange and Foreign Trade Act</a> (Legge sugli scambi e sul commercio estero), per completare la transazione.</p>");
    a.put(cs.ao, "Accedi");
    a.put(cs.ap, "Log in con PayPal");
    a.put(cs.aq, "Esci");
    a.put(cs.ar, "Esci");
    a.put(cs.as, "OK");
    a.put(cs.at, "Password");
    a.put(cs.au, "Paga dopo la consegna");
    a.put(cs.av, "Paga con");
    a.put(cs.aw, "Paga con una carta");
    a.put(cs.ax, "Saldo PayPal");
    a.put(cs.ay, "PayPal Credit");
    a.put(cs.az, "Telefono");
    a.put(cs.aA, "PIN");
    a.put(cs.aB, "Metodo di pagamento preferito");
    a.put(cs.aC, "PayPal protegge la tua <a href='%s'>privacy</a> e i tuoi dati finanziari.");
    a.put(cs.aD, "Elaborazione in corso");
    a.put(cs.aE, "Ricorda dati carta");
    a.put(cs.aF, "Richiedi denaro");
    a.put(cs.aG, "<h1><strong>%s</strong></h1><p>Tutti i dettagli rilevanti della transazione verranno condivisi con il commerciante.</p><p>Per annullare il consenso, accedi al tuo conto PayPal, seleziona l’icona <strong>Profilo</strong> &gt; Sicurezza &gt; <strong>Log in con PayPal</strong> e rimuovi questo commerciante.</p><p>PayPal non è responsabile di azioni o errori da parte del Partner.</p>");
    a.put(cs.aH, "Conto corrente");
    a.put(cs.aI, "Invia denaro");
    a.put(cs.aJ, "Si è verificato un problema con i nostri server. Riprova.");
    a.put(cs.aK, "Ripeti l’accesso a PayPal.");
    a.put(cs.aL, "Sessione scaduta");
    a.put(cs.aM, "Indirizzo di spedizione");
    a.put(cs.aN, "Non hai un conto PayPal? Registrati");
    a.put(cs.aO, "Rimani collegato");
    a.put(cs.aP, "Errore di sistema (%s). Riprova più tardi.");
    a.put(cs.aQ, "Riprova");
    a.put(cs.aR, "Impossibile effettuare l’accesso perché sul tuo conto è attiva la doppia autenticazione.");
    a.put(cs.aS, "Codice di sicurezza");
    a.put(cs.aT, "Ricevi un SMS sul tuo telefono. Il codice a 6 cifre sarà valido per 5 minuti.");
    a.put(cs.aU, "Invio SMS in corso");
    a.put(cs.aV, "Immetti il codice di sicurezza a 6 cifre");
    a.put(cs.aW, "Numero di cellulare");
    a.put(cs.aX, "Ricevi SMS");
    a.put(cs.aY, "Ricevi un altro SMS");
    a.put(cs.aZ, "Impossibile effettuare l’accesso perché sul tuo conto è attiva la doppia autenticazione. Visita il sito PayPal per attivare la chiave di accesso.");
    a.put(cs.ba, "Pagamenti da questo dispositivo non consentiti.");
    a.put(cs.bb, "Dispositivo non autorizzato");
    a.put(cs.bc, "I pagamenti a questo venditore non sono consentiti (clientId non valido).");
    a.put(cs.bd, "Sito non valido");
    a.put(cs.be, "Si è verificato un problema durante l’elaborazione del pagamento. Riprova.");
    a.put(cs.bf, "Metodo non riconosciuto");
    a.put(cs.bg, "Spiacenti");
    a.put(cs.bh, "Il tuo ordine");
    a.put(cs.bi, "Rimuovere la carta?");
    a.put(cs.bj, "Consenso non riuscito");
    a.put(cs.bk, "Connessione non riuscita");
    a.put(cs.bl, "Accesso non riuscito");
    a.put(cs.bm, "Accedi con la password");
    a.put(cs.bn, "Accedi con il PIN");
    a.put(cs.bo, "Attendi…");
    a.put(cs.bp, "Pagamento non riuscito");
    a.put(cs.bq, "Scansione");
    a.put(cs.br, "Codice di sicurezza errato. Riprova.");
    a.put(cs.bs, "tramite");
    a.put(cs.bt, "Errore di sistema. Riprova più tardi.");
    ...
    c.put("FEATURE_UNSUPPORTED_FOR_PAYEE", "La funzione è non supportata per questo beneficiario.");
    ...
    c.put("PAYMENT_CREATION_ERROR", "Si è verificato un problema nella disposizione del pagamento. Visita il sito web PayPal per controllare il tuo conto.");
    c.put("PAYMENT_CREATION_ERROR_EXPIRED_PAYMENT_CARD", "Si è verificato un problema nella disposizione del pagamento: la tua carta è scaduta. Visita il sito web PayPal per controllare il tuo conto.");
    c.put("PAYMENT_CREATION_ERROR_INSTANT_PAYMENT_REQUIRED", "Si è verificato un problema nella disposizione del pagamento: è richiesto un pagamento immediato, ad esempio una carta di credito. Visita il sito web PayPal per controllare il tuo conto.");
    c.put("PAYMENT_CREATION_ERROR_NEED_CONFIRMED_CARD", "Si è verificato un problema nella disposizione del pagamento: la carta deve essere confermata. Visita il sito web PayPal per controllare il tuo conto.");
    c.put("PAYMENT_CREATION_ERROR_NEED_PHONE_NUMBER", "Si è verificato un problema nella disposizione del pagamento: questa applicazione richiede che sul tuo conto sia registrato un numero di telefono. Visita il sito web PayPal per controllare il tuo conto.");
    c.put("PAYMENT_CREATION_ERROR_NEED_VALID_FUNDING_INSTRUMENT", "Si è verificato un problema nella disposizione del pagamento: il conto necessita di un metodo di pagamento valido, ad esempio un conto bancario o una carta di pagamento. Visita il sito web PayPal per controllare il tuo conto.");
    c.put("PAYMENT_CREATION_ERROR_NEGATIVE_BALANCE", "Si è verificato un problema nella disposizione del pagamento: il tuo saldo è negativo. Visita il sito web PayPal per controllare il tuo conto.");
    c.put("PAYMENT_CREATION_ERROR_SENDING_LIMIT_REACHED", "Si è verificato un problema nella disposizione del pagamento: hai raggiunto il tuo limite di invio. Visita il sito web PayPal per controllare il tuo conto.");
