  ...
  implements j
{
  ...
  public n()
  {
    ...
    a.put(cs.v, "Visa");
    a.put(cs.w, "Change Payment Method");
    a.put(cs.x, "Checking");
    a.put(cs.y, "Checking this device…");
    a.put(cs.z, "Clear card information");
    a.put(cs.A, "Confirm");
    a.put(cs.B, "Are you sure you want to clear your card information?");
    ...
    a.put(cs.L, "Birth Date");
    a.put(cs.M, "Email address");
    a.put(cs.N, "Full Name");
    a.put(cs.O, "Gender");
    a.put(cs.P, "Language");
    a.put(cs.Q, "Locale");
    a.put(cs.R, "Telephone");
    a.put(cs.S, "Time Zone");
    a.put(cs.T, "Share the following: %s.");
    a.put(cs.U, "%s asks that you:");
    a.put(cs.V, "Share the <a href='%1$s'>payment methods</a> linked to your PayPal account.");
    a.put(cs.W, "Enable display of your funding options to allow you to make a choice.");
    a.put(cs.X, "<a href='%1$s'>Authorize charges</a> for future %2$s purchases paid for with PayPal. You instruct PayPal to pay all amounts requested by %3$s.");
    ...
    a.put(cs.af, "Sandbox");
    a.put(cs.ag, "Expires");
    a.put(cs.ah, "<h1><strong>Payment Methods</strong></h1><p>PayPal only shares which of your payment methods are available for use.</p>");
    a.put(cs.ai, "Forgot password?");
    a.put(cs.aj, "From");
    ...
    a.put(cs.az, "Phone");
    a.put(cs.aA, "PIN");
    a.put(cs.aB, "Preferred Payment Method");
    ...
    a.put(cs.aK, "Please log in again to PayPal.");
    a.put(cs.aL, "Session Expired");
    a.put(cs.aM, "Shipping Address");
    ...
    a.put(cs.aV, "Enter the 6-digit security code");
    ...
    a.put(cs.bb, "Unauthorized Device");
    ...
    a.put(cs.bf, "Unrecognized Source");
