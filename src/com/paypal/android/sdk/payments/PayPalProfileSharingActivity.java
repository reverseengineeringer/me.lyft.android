  ...
  extends Activity
{
  ...
  protected final void onCreate(Bundle paramBundle)
  {
    ...
    new cB(this).a();
    new cA(this).a();
    new cz(this).a(Arrays.asList(new String[] { PayPalProfileSharingActivity.class.getName(), LoginActivity.class.getName(), FuturePaymentInfoActivity.class.getName(), ProfileSharingConsentActivity.class.getName() }));
