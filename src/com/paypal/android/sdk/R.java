  ...
  implements j
{
  ...
  public r()
  {
    ...
    a.put(cs.B, "¿Seguro que desea borrar los datos de su tarjeta?");
    a.put(cs.C, "Cargar en tarjeta");
    a.put(cs.D, "¿Está seguro que desea cerrar la sesión de PayPal?");
    a.put(cs.E, "Pagar");
    a.put(cs.F, "Aceptar");
    ...
    a.put(cs.M, "Dirección de correo electrónico");
    a.put(cs.N, "Nombre completo");
    a.put(cs.O, "Sexo");
    a.put(cs.P, "Idioma");
    a.put(cs.Q, "Configuración regional");
    a.put(cs.R, "Teléfono");
    ...
    a.put(cs.W, "Active la visualización de sus opciones de pago para que usted pueda elegir.");
    ...
    a.put(cs.Z, "Acepte la <a href='%2$s'>Política de privacidad</a> y las <a href='%3$s'>Condiciones de uso</a> de %1$s.");
    ...
    a.put(cs.ac, "Permiso");
    a.put(cs.ad, "Correo electrónico");
    a.put(cs.ae, "Datos de prueba");
    a.put(cs.af, "Sandbox");
    a.put(cs.ag, "Caduca");
    a.put(cs.ah, "<h1><strong>Formas de pago</strong></h1><p>PayPal solo comparte las formas de pago que están disponibles para su utilización.</p>");
    a.put(cs.ai, "¿Olvidó su contraseña?");
    a.put(cs.aj, "De");
    a.put(cs.ak, "¿Cómo le gustaría respaldar sus pagos futuros %1$s?");
    a.put(cs.al, "<h1><strong>Acuerdo de pago futuro</strong></h1><p>Su forma de pago predeterminada se utilizará para realizar futuros pagos con PayPal de este vendedor.</p><p>Para cancelar este acuerdo, inicie sesión en su cuenta PayPal, vaya a <strong>Perfil</strong> &gt; <strong>Mi configuración</strong> &gt; <strong>Iniciar sesión con PayPal</strong> y eliminar a este comercio de la lista.</p><p>Aplicará el artículo Pagos recurrentes de las <a href='%s'>Condiciones de uso de PayPal</a>.</p><p>Para asegurarse de que los pagos con tu cuenta PayPal funcionen correctamente, esta aplicación puede simular una pequeña transacción de prueba, pero no se transferirá dinero.</p>");
    a.put(cs.am, "Error interno");
    a.put(cs.an, "<p>Al hacer clic en el botón a continuación, por el presente documento acepto los términos de las <a href='%1$s'>Condiciones de uso de PayPal</a> y declaro que cumplo las leyes y normas japonesas, incluidas las sanciones contra pagos a Corea del Norte e Irán de conformidad con la <a href='%2$s'>Ley de divisas y comercio exterior</a> para realizar la transacción.</p>");
    ...
    a.put(cs.au, "Pagar después de la entrega");
    ...
    a.put(cs.aC, "PayPal protege su <a href='%s'>privacidad</a> e información financiera.");
    ...
    a.put(cs.aJ, "Se ha producido un problema en la comunicación con los servidores de PayPal. Inténtelo de nuevo.");
    a.put(cs.aK, "Inicie sesión de nuevo en PayPal.");
    a.put(cs.aL, "Sesión caducada");
    a.put(cs.aM, "Dirección de envío");
    a.put(cs.aN, "¿Nuevo usuario de PayPal? Registrarse");
    a.put(cs.aO, "Mantener la sesión activa");
    a.put(cs.aP, "Error de sistema (%s). Inténtelo de nuevo más tarde.");
    a.put(cs.aQ, "Inténtelo de nuevo");
    a.put(cs.aR, "No logra iniciar sesión, porque la autenticación de dos factores fue activada para su cuenta.");
    a.put(cs.aS, "Código de seguridad");
    a.put(cs.aT, "Envíe un mensaje de texto a su teléfono. El código de 6 dígitos que reciba será válido durante 5 minutos.");
    a.put(cs.aU, "Enviando mensaje de texto");
    a.put(cs.aV, "Ingrese el código de seguridad de 6 dígitos.");
    a.put(cs.aW, "Su teléfono móvil");
    a.put(cs.aX, "Enviar mensaje de texto");
    a.put(cs.aY, "Enviar mensaje de texto de nuevo");
    a.put(cs.aZ, "No es posible iniciar sesión porque se ha activado la autenticación de dos factores para la cuenta. Visite el sitio web de PayPal para activar su clave de seguridad.");
    a.put(cs.ba, "No se permiten los pagos desde este dispositivo.");
    a.put(cs.bb, "Dispositivo no autorizado");
    a.put(cs.bc, "Los pagos a este comercio no se permiten (id. de cliente no válida).");
    a.put(cs.bd, "Comercio no válido");
    a.put(cs.be, "Hubo un problema al procesar su pago. Inténtelo de nuevo.");
    a.put(cs.bf, "Origen no reconocido");
    a.put(cs.bg, "Lo sentimos");
    a.put(cs.bh, "Su pedido");
    a.put(cs.bi, "¿Eliminar tarjeta?");
    ...
    a.put(cs.bn, "Iniciar sesión con NIP");
    a.put(cs.bo, "Un momento…");
    a.put(cs.bp, "Error de pago");
    a.put(cs.bq, "Escanear");
    a.put(cs.br, "Código de seguridad incorrecto. Inténtelo de nuevo.");
    a.put(cs.bs, "Vía");
    a.put(cs.bt, "Error del sistema. Inténtelo de nuevo más tarde.");
