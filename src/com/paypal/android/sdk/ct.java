...
public final class ct
{
  ...
  public ct(Context paramContext)
  {
    ...
    while (m < 10)
    {
      ...
      localTextView.setTextColor(bi.i);
      localTextView.setLinkTextColor(bi.p);
      localTextView.setTypeface(bi.o);
      localTextView.setTextSize(18.0F);
      localTextView.setSingleLine(false);
      localTextView.setMovementMethod(LinkMovementMethod.getInstance());
      localLinearLayout.addView(localTextView);
      bj.a(localTextView, -1, -2);
      bj.a(localTextView, null, "10dip");
    ...
    bj.a(e, -1, -2);
    bj.b(e, null, "20dip", null, "10dip");
    e.setVisibility(8);
    h = bj.a(paramContext, true, 1, localLinearLayout);
    ...
    bj.b(g, null, null, null, "16dip");
    bj.a(g, -2, -2);
    bj.a(g, 17, 1.0F);
    g.setNextFocusLeftId(1);
    f = new cu(paramContext);
    k.addView(f.a);
    bj.a(f.a, -2, -2);
    bj.a(f.a, 17, 1.0F);
    a = j;
