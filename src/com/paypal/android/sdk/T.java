  ...
  implements j
{
  ...
  public t()
  {
    a.put(cs.a, "הסכם ושלם");
    a.put(cs.b, "ואחרים");
    a.put(cs.c, "אימות");
    a.put(cs.d, "חזרה");
    a.put(cs.e, "גיבוי");
    a.put(cs.f, "ביטול");
    a.put(cs.g, "אמריקן אקספרס");
    ...
    a.put(cs.p, "JCB‏");
    a.put(cs.q, "Maestro‏");
    a.put(cs.r, "מאסטרקארד");
    a.put(cs.s, "Postepay‏");
    a.put(cs.t, "‎4 étoiles‎‏");
    a.put(cs.u, "Tarjeta Aurora‏");
    a.put(cs.v, "ויזה");
    a.put(cs.w, "שנה שיטת תשלום");
    a.put(cs.x, "עו״ש");
    a.put(cs.y, "בודק מכשיר זה…");
    a.put(cs.z, "נקה פרטי כרטיס");
    a.put(cs.A, "אשר");
    a.put(cs.B, "האם אתה בטוח שאתה רוצה להסיר את פרטי הכרטיס שלך?");
    a.put(cs.C, "חייב כרטיס");
    a.put(cs.D, "האם אתה בטוח שאתה רוצה לצאת מ-PayPal‏?");
    a.put(cs.E, "שלם");
    a.put(cs.F, "מסכים");
    a.put(cs.G, "תאריך פתיחת החשבון");
    a.put(cs.H, "מצב חשבון");
    a.put(cs.I, "סוג חשבון");
    a.put(cs.J, "כתובת");
    a.put(cs.K, "טווח גילים");
    a.put(cs.L, "תאריך לידה");
    a.put(cs.M, "כתובת אימייל");
    a.put(cs.N, "שם מלא");
    a.put(cs.O, "מין");
    a.put(cs.P, "שפה");
    a.put(cs.Q, "אזור");
    a.put(cs.R, "טלפון");
    a.put(cs.S, "אזור זמן");
    a.put(cs.T, "שתף את הפרטים הבאים: ‎%s‏.");
    a.put(cs.U, "%s מבקש כי:");
    a.put(cs.V, "שתף את <a href='%1$s'>שיטות התשלום</a> המקושרות לחשבון ה-PayPal שלך.");
    a.put(cs.W, "הפעל תצוגה של האפשרויות הכספיות שלך שתאפשר לך לבחור.");
    a.put(cs.X, "<a href='%1$s'>אשר חיובים</a> עבור קניות עתידיות אצל ‎%2$s באמצעות PayPal‏. הורית ל-PayPal לשלם את כל הסכומים ש-‎%3$s מבקש.");
    a.put(cs.Y, "תאפשר לו להוסיף ולנהל את כרטיס המועדון שלו ב‘ארנק‘ שבחשבון ה-PayPal שלך.");
    a.put(cs.Z, "תסכים ל<a href='%2$s'>מדיניות הפרטיות</a> ו<a href='%3$s'>הסכם המשתמש</a> של %1$s‏.");
    a.put(cs.aa, "תאפשר לו <a href='%1$s'>לבקש תשלום</a> בשמך, עד שתבטל את הסכמתך.");
    a.put(cs.ab, "תאפשר לו <a href='%1$s'>לשלוח תשלום</a> בשמך, עד שתבטל את הסכמתך.");
    a.put(cs.ac, "הסכמה");
    a.put(cs.ad, "אימייל");
    a.put(cs.ae, "פרטים מדומים");
    a.put(cs.af, "‏Sandbox");
    a.put(cs.ag, "תאריך תפוגה");
    a.put(cs.ah, "<h1><strong>דרכי תשלום</strong></h1><p>המידע היחיד ש-PayPal משתפת הוא אילו משיטות התשלום שלך זמינות לשימוש.</p>");
    a.put(cs.ai, "שכחת את הסיסמה?");
    a.put(cs.aj, "מ-");
    a.put(cs.ak, "כיצד תרצה לשלם עבור תשלומים עתידיים ל-%1$s‏?");
    a.put(cs.al, "<h1><strong>הסכם תשלום עתידי</strong></h1><p>ברירת המחדל לשיטת התשלום שלך תשמש עבור תשלומים עתידיים באמצעות PayPal אצל בעל עסק זה.</p><p>כדי לבטל הסכם זה, היכנס לחשבון ה-PayPal שלך, עבור אל <strong>פרופיל</strong> &gt; <strong>ההגדרות שלי</strong> &gt; <strong>היכנס עם PayPal</strong> והסר בעל עסק זה מהרשימה.</p><p>המקטע ‘הוראת קבע‘ של <a href='%s'>הסכם המשתמש של PayPal</a> יחול.</p><p>כדי לוודא שהתשלומים שלך יעבדו עם חשבון ה-PayPal שלך, יישום זה עשוי לבצע הדמיה של עסקה קטנה לצורך בדיקה, אך בפועל לא יועבר כסף.</p>");
    a.put(cs.am, "שגיאה פנימית");
    a.put(cs.an, "<p>על-ידי לחיצה על הלחצן למטה, אני מסכים בזאת לתנאי <a href='%1$s'>הסכם המשתמש של PayPal</a> ומצהיר שאני פועל בהתאם לחוקים ולתקנות ביפן, כולל סנקציות נגד תשלום לצפון קוריאה ואירן, בהתאם ל-<a href='%2$s'>Foreign Exchange and Foreign Trade Act</a>, להשלמת העסקה.</p>");
    a.put(cs.ao, "כניסה");
    a.put(cs.ap, "היכנס עם PayPal‏");
    a.put(cs.aq, "יציאה");
    a.put(cs.ar, "יציאה");
    a.put(cs.as, "אישור");
    a.put(cs.at, "סיסמה");
    a.put(cs.au, "שלם לאחר המסירה");
    a.put(cs.av, "שלם באמצעות");
    a.put(cs.aw, "שלם באמצעות כרטיס");
    a.put(cs.ax, "יתרת חשבון ה-PayPal");
    a.put(cs.ay, "PayPal Credit");
    a.put(cs.az, "טלפון");
    a.put(cs.aA, "קוד סודי");
    a.put(cs.aB, "שיטת תשלום מועדפת");
    a.put(cs.aC, "PayPal מגינה על ה<a href='%s'>פרטיות</a> והמידע הפיננסי שלך.");
    a.put(cs.aD, "עיבוד");
    a.put(cs.aE, "זכור כרטיס");
    a.put(cs.aF, "בקש תשלום");
    a.put(cs.aG, "<h1><strong>%s</strong></h1><p>כל פרטי העסקה הרלוונטיים ישותפו עם בעל העסק.</p><p>כדי לבטל את הסכמתך, היכנס אל paypal.com, עבור אל אפשרויות <strong>היכנס עם PayPal</strong> תחת הגדרות ה<strong>פרופיל</strong> והסר בעל עסק זה.</p><p>PayPal אינה אחראית לפעולות או שגיאות כלשהן מצדו של השותף.</p>");
    a.put(cs.aH, "חיסכון");
    a.put(cs.aI, "שלח תשלום");
    a.put(cs.aJ, "הייתה בעיה ביצירת קשר עם השרתים של PayPal‏. נסה שוב.");
    a.put(cs.aK, "היכנס שוב ל-PayPal‏.");
    a.put(cs.aL, "פג תוקף ההפעלה");
    a.put(cs.aM, "כתובת למשלוח");
    a.put(cs.aN, "חדש ב-PayPal‏? הירשם");
    a.put(cs.aO, "הישאר מחובר");
    a.put(cs.aP, "שגיאת מערכת (%s‏). נסה שוב מאוחר יותר.");
    a.put(cs.aQ, "נסה שוב");
    a.put(cs.aR, "לא ניתן להיכנס לחשבון, משום שאימות בשני שלבים הופעל עבור החשבון שלך.");
    a.put(cs.aS, "קוד אבטחה");
    a.put(cs.aT, "שלח הודעת טקסט לטלפון שלך. הקוד בן שש הספרות שתקבל יישאר בתוקף למשך 5 דקות.");
    a.put(cs.aU, "שולח טקסט");
    a.put(cs.aV, "הזן את קוד האבטחה בן שש הספרות");
    a.put(cs.aW, "מספר הטלפון הנייד שלך");
    a.put(cs.aX, "שלח טקסט");
    a.put(cs.aY, "שלח טקסט שוב");
    a.put(cs.aZ, "לא ניתן להיכנס לחשבון, משום שאימות בשני שלבים הופעל עבור החשבון שלך. בקר באתר PayPal כדי להפעיל את מפתח האבטחה שלך.");
    a.put(cs.ba, "לא ניתן לשלם ממכשיר זה.");
    a.put(cs.bb, "מכשיר בלתי-מורשה");
    a.put(cs.bc, "לא ניתן לשלם לבעל עסק זה (מזהה לקוח בלתי-חוקי).");
    a.put(cs.bd, "בעל עסק בלתי-חוקי");
    a.put(cs.be, "אירעה בעיה בעיבוד התשלום שלך. נסה שוב.");
    a.put(cs.bf, "מקור בלתי מזוהה");
    a.put(cs.bg, "מצטערים");
    a.put(cs.bh, "ההזמנה שלך");
    a.put(cs.bi, "להסיר את הכרטיס?");
    a.put(cs.bj, "ההסכמה נכשלה");
    a.put(cs.bk, "החיבור נכשל");
    a.put(cs.bl, "הכניסה נכשלה");
    a.put(cs.bm, "היכנס באמצעות סיסמה");
    a.put(cs.bn, "היכנס באמצעות קוד סודי");
    a.put(cs.bo, "המתן רגע אחד…");
    a.put(cs.bp, "התשלום נכשל");
    a.put(cs.bq, "סריקה");
    a.put(cs.br, "קוד אבטחה שגוי. נסה שוב.");
    a.put(cs.bs, "באמצעות");
    a.put(cs.bt, "שגיאת מערכת. נסה שוב מאוחר יותר.");
