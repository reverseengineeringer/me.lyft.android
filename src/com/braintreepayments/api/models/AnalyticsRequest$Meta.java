...
class AnalyticsRequest$Meta
{
  ...
  AnalyticsRequest$Meta(AnalyticsRequest paramAnalyticsRequest, Context paramContext, String paramString)
  {
    String str = paramContext.getPackageName();
    PackageManager localPackageManager = paramContext.getPackageManager();
    try
    {
      paramAnalyticsRequest = localPackageManager.getApplicationInfo(str, 0);
      platform = "Android";
      platformVersion = Integer.toString(Build.VERSION.SDK_INT);
      sdkVersion = "1.4.0";
      merchantAppId = str;
      merchantAppName = getAppName(paramAnalyticsRequest, localPackageManager);
    ...
    catch (PackageManager.NameNotFoundException paramAnalyticsRequest)
    {
      for (;;)
      {
        paramAnalyticsRequest = null;
      }
    }
  }
...
/* Location:
 * Qualified Name:     com.braintreepayments.api.models.AnalyticsRequest.Meta
