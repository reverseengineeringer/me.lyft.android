...
public abstract class zzpr$zza<R extends Result, A extends Api.zzb>
  extends zzpt<R>
  implements zzpr.zzb<R>
{
  ...
  protected zzpr$zza(Api<?> paramApi, GoogleApiClient paramGoogleApiClient)
  {
    super((GoogleApiClient)zzab.zzb(paramGoogleApiClient, "GoogleApiClient must not be null"));
    sz = paramApi.zzanp();
    pD = paramApi;
  }
...
/* Location:
 * Qualified Name:     com.google.android.gms.internal.zzpr.zza
