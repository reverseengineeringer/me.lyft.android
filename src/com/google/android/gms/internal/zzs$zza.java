...
class zzs$zza
{
  ...
  private long zzw()
  {
    ...
    long l = zzbk.get(0)).time;
    return zzbk.get(zzbk.size() - 1)).time - l;
  }
  ...
  public void zza(String paramString, long paramLong)
  {
    ...
    zzbk.add(new zza(paramString, paramLong, SystemClock.elapsedRealtime()));
  }
  ...
  public void zzd(String paramString)
  {
    ...
    //   7: aload_0
    //   8: invokespecial 86	com/google/android/gms/internal/zzs$zza:zzw	()J
    //   11: lstore 4
    //   13: lload 4
    //   15: lconst_0
    //   16: lcmp
