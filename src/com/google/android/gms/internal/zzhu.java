...
public abstract interface zzhu
  extends IInterface
{
  public abstract IBinder zzo(zzd paramzzd)
  ...
  public static abstract class zza
    ...
    implements zzhu
  {
    public static zzhu zzaw(IBinder paramIBinder)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof zzhu))) {
        return (zzhu)localIInterface;
      }
      ...
      throws RemoteException
    {
      ...
      paramParcel1 = zzo(zzd.zza.zzfc(paramParcel1.readStrongBinder()));
      ...
      implements zzhu
    {
      ...
      /* Error */
      public IBinder zzo(zzd paramzzd)
        throws RemoteException
      {
        // Byte code:
