...
public abstract class zzug$zza
  extends Binder
  implements zzug
{
  public zzug$zza()
  ...
  public static zzug asInterface(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("com.google.android.gms.flags.IFlagProvider");
    if ((localIInterface != null) && ((localIInterface instanceof zzug))) {
      return (zzug)localIInterface;
    }
...
/* Location:
 * Qualified Name:     com.google.android.gms.internal.zzug.zza
