  ...
  implements zzf
{
  ...
  private void zza(Map<String, String> paramMap, zzb.zza paramzza)
  {
    ...
    do
    {
      return;
      if (zza != null) {
        paramMap.put("If-None-Match", zza);
      }
    } while (zzc <= 0L);
    paramMap.put("If-Modified-Since", DateUtils.formatDate(new Date(zzc)));
  }
  
  private byte[] zza(HttpEntity paramHttpEntity)
    throws IOException, zzp
  {
    zzaa localzzaa = new zzaa(zzbq, (int)paramHttpEntity.getContentLength());
    ...
    try
    {
      ...
      zzbq.zza((byte[])localObject1);
      localzzaa.close();
      throw ((Throwable)localObject3);
      localObject1 = localObject3;
      byte[] arrayOfByte = zzbq.zzb(1024);
      for (;;)
      {
