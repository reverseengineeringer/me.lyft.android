...
public abstract interface zzhs
  extends IInterface
{
  public abstract void zza(zzhr paramzzhr)
    ...
    implements zzhs
  {
    ...
    public static zzhs zzau(IBinder paramIBinder)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof zzhs))) {
        return (zzhs)localIInterface;
      }
      ...
      throws RemoteException
    {
      ...
      zza(zzhr.zza.zzat(paramParcel1.readStrongBinder()));
      ...
      implements zzhs
    {
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/internal/zzhs$zza$zza:zzahn	Landroid/os/IBinder;
        //   34: iconst_1
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
