  ...
  implements zzy
{
    ...
    throws IOException
  {
    ...
    if (("https".equals(paramURL.getProtocol())) && (zzcf != null)) {
      ((HttpsURLConnection)localHttpURLConnection).setSSLSocketFactory(zzcf);
    }
    ...
    throws IOException, zza
  {
    ...
    if (zzce != null)
    {
      str = zzce.zzh((String)localObject);
      paramMap = str;
      if (str == null)
      {
