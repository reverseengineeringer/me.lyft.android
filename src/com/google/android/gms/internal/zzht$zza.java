...
public abstract class zzht$zza
  extends Binder
  implements zzht
{
  public zzht$zza()
  ...
  public static zzht zzav(IBinder paramIBinder)
  {
    ...
    if ((localIInterface != null) && ((localIInterface instanceof zzht))) {
      return (zzht)localIInterface;
    }
    ...
    implements zzht
  {
      ...
      throws RemoteException
    {
      ...
      //   46: aload_0
      //   47: getfield 18	com/google/android/gms/internal/zzht$zza$zza:zzahn	Landroid/os/IBinder;
      //   50: iconst_3
      //   51: aload 4
      //   53: aload 5
      //   55: iconst_0
