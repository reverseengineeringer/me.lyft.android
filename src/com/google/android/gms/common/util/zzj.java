...
public final class zzj
{
  ...
  private static float AR = NaN.0F;
  ...
  public static int zzcm(Context paramContext)
  {
    ...
    Intent localIntent = paramContext.getApplicationContext().registerReceiver(null, AP);
    if (localIntent == null)
    {
      i = 0;
      if ((i & 0x7) == 0) {
  ...
  public static float zzcn(Context paramContext)
  {
    ...
    //   6: getstatic 84	com/google/android/gms/common/util/zzj:AQ	J
    //   9: lsub
    //   10: ldc2_w 85
    //   13: lcmp
    //   14: ifge +21 -> 35
    //   17: getstatic 25	com/google/android/gms/common/util/zzj:AR	F
    //   20: invokestatic 92	java/lang/Float:isNaN	(F)Z
    //   23: ifne +12 -> 35
    //   26: getstatic 25	com/google/android/gms/common/util/zzj:AR	F
    //   29: fstore_1
    //   30: ldc 2
    //   32: monitorexit
    //   33: fload_1
    ...
    //   39: aconst_null
    //   40: getstatic 22	com/google/android/gms/common/util/zzj:AP	Landroid/content/IntentFilter;
    ...
    //   70: i2f
    //   71: fdiv
    //   72: putstatic 25	com/google/android/gms/common/util/zzj:AR	F
    //   75: invokestatic 82	android/os/SystemClock:elapsedRealtime	()J
    //   78: putstatic 84	com/google/android/gms/common/util/zzj:AQ	J
    //   81: getstatic 25	com/google/android/gms/common/util/zzj:AR	F
    //   84: fstore_1
    //   85: goto -55 -> 30
    //   88: astore_0
    //   89: ldc 2
