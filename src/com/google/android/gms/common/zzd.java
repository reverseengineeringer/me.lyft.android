...
import com.google.android.gms.internal.zzsj.zza;
...
class zzd
{
  ...
  private static Set<zzs> zza(IBinder[] paramArrayOfIBinder)
    throws RemoteException
  {
    ...
    if (i < j)
    {
      zzs localzzs = zzs.zza.zzdr(paramArrayOfIBinder[i]);
      if (localzzs == null) {
  ...
  private static boolean zzane()
  {
    ...
    try
    {
      localObject = zzsj.zza(qX, zzsj.Mk, "com.google.android.gms.googlecertificates");
      Log.d("GoogleCertificates", "com.google.android.gms.googlecertificates module is loaded");
      qW = zzv.zza.zzdu(((zzsj)localObject).zziv("com.google.android.gms.common.GoogleCertificatesImpl"));
      return true;
    }
  ...
  /* Error */
  static Set<zzs> zzanf()
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 132	com/google/android/gms/common/zzd:qY	Ljava/util/Set;
    //   6: ifnull +12 -> 18
    //   9: getstatic 132	com/google/android/gms/common/zzd:qY	Ljava/util/Set;
    //   12: astore_1
    //   13: ldc 2
    //   15: monitorexit
    //   16: aload_1
    //   17: areturn
    //   18: getstatic 77	com/google/android/gms/common/zzd:qW	Lcom/google/android/gms/common/internal/zzv;
    //   21: ifnonnull +16 -> 37
    //   24: invokestatic 134	com/google/android/gms/common/zzd:zzane	()Z
    //   27: ifne +10 -> 37
    //   30: getstatic 139	java/util/Collections:EMPTY_SET	Ljava/util/Set;
    //   33: astore_1
    //   34: goto -21 -> 13
    //   37: getstatic 77	com/google/android/gms/common/zzd:qW	Lcom/google/android/gms/common/internal/zzv;
    ...
    //   62: goto -49 -> 13
    //   65: aload_1
    //   66: invokestatic 153	com/google/android/gms/dynamic/zze:zzad	(Lcom/google/android/gms/dynamic/zzd;)Ljava/lang/Object;
    ...
    //   75: putstatic 132	com/google/android/gms/common/zzd:qY	Ljava/util/Set;
    //   78: iconst_0
    //   79: istore_0
    //   80: iload_0
    //   81: getstatic 161	com/google/android/gms/common/zzd$zzd:re	[Lcom/google/android/gms/common/zzd$zza;
    //   84: arraylength
    //   85: if_icmpge +24 -> 109
    //   88: getstatic 132	com/google/android/gms/common/zzd:qY	Ljava/util/Set;
    //   91: getstatic 161	com/google/android/gms/common/zzd$zzd:re	[Lcom/google/android/gms/common/zzd$zza;
    //   94: iload_0
    //   95: aaload
    ...
    //   105: istore_0
    //   106: goto -26 -> 80
    //   109: getstatic 132	com/google/android/gms/common/zzd:qY	Ljava/util/Set;
    //   112: invokestatic 165	java/util/Collections:unmodifiableSet	(Ljava/util/Set;)Ljava/util/Set;
    //   115: putstatic 132	com/google/android/gms/common/zzd:qY	Ljava/util/Set;
    //   118: getstatic 132	com/google/android/gms/common/zzd:qY	Ljava/util/Set;
    //   121: astore_1
    //   122: goto -109 -> 13
    //   125: astore_1
    //   126: ldc 45
  ...
  /* Error */
  static Set<zzs> zzang()
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 171	com/google/android/gms/common/zzd:qZ	Ljava/util/Set;
    //   6: ifnull +12 -> 18
    //   9: getstatic 171	com/google/android/gms/common/zzd:qZ	Ljava/util/Set;
    //   12: astore_0
    //   13: ldc 2
    //   15: monitorexit
    //   16: aload_0
    ...
    //   69: checkcast 155	[Landroid/os/IBinder;
    //   72: invokestatic 157	com/google/android/gms/common/zzd:zza	([Landroid/os/IBinder;)Ljava/util/Set;
    //   75: putstatic 171	com/google/android/gms/common/zzd:qZ	Ljava/util/Set;
    //   78: getstatic 171	com/google/android/gms/common/zzd:qZ	Ljava/util/Set;
    //   81: getstatic 161	com/google/android/gms/common/zzd$zzd:re	[Lcom/google/android/gms/common/zzd$zza;
    //   84: iconst_0
    //   85: aaload
    //   86: invokeinterface 59 2 0
    //   91: pop
    //   92: getstatic 171	com/google/android/gms/common/zzd:qZ	Ljava/util/Set;
    //   95: invokestatic 165	java/util/Collections:unmodifiableSet	(Ljava/util/Set;)Ljava/util/Set;
    //   98: putstatic 171	com/google/android/gms/common/zzd:qZ	Ljava/util/Set;
    //   101: getstatic 171	com/google/android/gms/common/zzd:qZ	Ljava/util/Set;
    //   104: astore_0
    //   105: goto -92 -> 13
    //   108: astore_0
    //   109: ldc 45
  ...
  /* Error */
  static void zzbq(Context paramContext)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 69	com/google/android/gms/common/zzd:qX	Landroid/content/Context;
    //   6: ifnonnull +18 -> 24
    //   9: aload_0
    //   10: ifnull +10 -> 20
    //   13: aload_0
    //   14: invokevirtual 186	android/content/Context:getApplicationContext	()Landroid/content/Context;
    //   17: putstatic 69	com/google/android/gms/common/zzd:qX	Landroid/content/Context;
    //   20: ldc 2
    //   22: monitorexit
    //   23: return
    //   24: ldc 45
    ...
    extends zzs.zza
  {
    ...
    public boolean equals(Object paramObject)
    {
      ...
      try
      {
        ...
        paramObject = (byte[])zze.zzad((com.google.android.gms.dynamic.zzd)paramObject);
