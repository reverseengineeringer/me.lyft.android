...
public abstract interface zzt
  extends IInterface
{
  public abstract IBinder zza(zzd paramzzd, String paramString, zzgn paramzzgn, int paramInt)
    ...
    implements zzt
  {
      ...
      implements zzt
    {
      ...
      /* Error */
      public IBinder zza(zzd paramzzd, String paramString, zzgn paramzzgn, int paramInt)
        throws RemoteException
      {
        // Byte code:
        //   0: aconst_null
