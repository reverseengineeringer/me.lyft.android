  ...
  extends zzaa
{
  ...
  public void zza(String paramString, URL paramURL, Map<String, String> paramMap, zza paramzza)
  {
    ...
    zzab.zzaa(paramURL);
    zzab.zzaa(paramzza);
    zzbsy().zzm(new zzc(paramString, paramURL, null, paramMap, paramzza));
  }
  ...
  public void zza(String paramString, URL paramURL, byte[] paramArrayOfByte, Map<String, String> paramMap, zza paramzza)
  {
    ...
    zzab.zzaa(paramzza);
    zzbsy().zzm(new zzc(paramString, paramURL, paramArrayOfByte, paramMap, paramzza));
  }
    ...
    throws IOException
  {
    ...
    paramURL.setConnectTimeout((int)zzbtb().zzbrx());
    paramURL.setReadTimeout((int)zzbtb().zzbry());
