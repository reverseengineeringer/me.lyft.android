  ...
  extends IInterface
{
  ...
  {
    public static ICameraUpdateFactoryDelegate zzhf(IBinder paramIBinder)
    {
      ...
      implements ICameraUpdateFactoryDelegate
    {
        ...
        throws RemoteException
      {
        ...
        try
        {
          ...
          com.google.android.gms.dynamic.zzd localzzd = zzd.zza.zzfc(localParcel2.readStrongBinder());
          return localzzd;
        }
        finally
        {
