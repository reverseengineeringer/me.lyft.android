...
public abstract interface zzt
  extends IInterface
{
  public abstract void zzae(zzd paramzzd)
    ...
    implements zzt
  {
    ...
    public static zzt zzic(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      zzae(zzd.zza.zzfc(paramParcel1.readStrongBinder()));
      ...
      implements zzt
    {
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/maps/internal/zzt$zza$zza:zzahn	Landroid/os/IBinder;
        //   34: iconst_1
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
