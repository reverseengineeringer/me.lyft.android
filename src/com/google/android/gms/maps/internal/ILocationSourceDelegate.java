...
public abstract interface ILocationSourceDelegate
  extends IInterface
{
  public abstract void activate(zzl paramzzl)
    ...
    implements ILocationSourceDelegate
  {
    ...
    public static ILocationSourceDelegate zzhk(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      case 1: 
        ...
        activate(zzl.zza.zzhu(paramParcel1.readStrongBinder()));
      ...
      implements ILocationSourceDelegate
    {
      ...
      /* Error */
      public void activate(zzl paramzzl)
        throws RemoteException
      {
        // Byte code:
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/maps/internal/ILocationSourceDelegate$zza$zza:zzahn	Landroid/os/IBinder;
        //   34: iconst_1
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
