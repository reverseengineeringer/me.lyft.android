  ...
  implements Parcelable.Creator<GroundOverlayOptions>
{
  static void zza(GroundOverlayOptions paramGroundOverlayOptions, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 2, paramGroundOverlayOptions.zzbqg(), false);
  ...
  public GroundOverlayOptions zzny(Parcel paramParcel)
  {
  ...
  public GroundOverlayOptions[] zzup(int paramInt)
  {
