  ...
  extends IInterface
{
  ...
  public abstract void zza(PendingIntent paramPendingIntent, zzql paramzzql)
    throws RemoteException;
  ...
  public abstract void zza(ActivityRecognitionRequest paramActivityRecognitionRequest, PendingIntent paramPendingIntent, zzql paramzzql)
    throws RemoteException;
  
  public abstract void zza(GeofencingRequest paramGeofencingRequest, PendingIntent paramPendingIntent, zzh paramzzh)
    throws RemoteException;
  
  public abstract void zza(GestureRequest paramGestureRequest, PendingIntent paramPendingIntent, zzql paramzzql)
    throws RemoteException;
  ...
  public abstract void zzb(PendingIntent paramPendingIntent, zzql paramzzql)
    throws RemoteException;
  
  public abstract Location zzbnk()
    throws RemoteException;
  
  public abstract void zzbx(boolean paramBoolean)
    throws RemoteException;
  
  public abstract void zzc(PendingIntent paramPendingIntent)
    throws RemoteException;
  
  public abstract void zzc(PendingIntent paramPendingIntent, zzql paramzzql)
    throws RemoteException;
  
  public abstract void zzc(Location paramLocation)
    throws RemoteException;
  
  public abstract void zzd(PendingIntent paramPendingIntent, zzql paramzzql)
    throws RemoteException;
  
  public abstract void zze(PendingIntent paramPendingIntent, zzql paramzzql)
    throws RemoteException;
  
  public abstract ActivityRecognitionResult zzkm(String paramString)
    throws RemoteException;
  
  public abstract Location zzkn(String paramString)
    throws RemoteException;
  
  public abstract LocationAvailability zzko(String paramString)
    throws RemoteException;
