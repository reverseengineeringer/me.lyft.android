  ...
  extends IInterface
{
  ...
  public abstract void zzea(Status paramStatus)
    throws RemoteException;
  
  public abstract void zzeb(Status paramStatus)
    throws RemoteException;
    ...
    implements zzd
  {
    ...
    public static zzd zzkh(IBinder paramIBinder)
    {
      ...
      implements zzd
    {
        ...
        throws RemoteException
      {
        ...
        //   29: aload_0
        //   30: getfield 18	com/google/android/gms/signin/internal/zzd$zza$zza:zzahn	Landroid/os/IBinder;
        //   33: bipush 8
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
      ...
      /* Error */
      public void zzea(Status paramStatus)
        throws RemoteException
      {
        // Byte code:
        //   0: invokestatic 30	android/os/Parcel:obtain	()Landroid/os/Parcel;
      ...
      /* Error */
      public void zzeb(Status paramStatus)
        throws RemoteException
      {
        // Byte code:
        //   0: invokestatic 30	android/os/Parcel:obtain	()Landroid/os/Parcel;
