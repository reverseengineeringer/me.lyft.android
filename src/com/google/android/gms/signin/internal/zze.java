  ...
  extends IInterface
{
  ...
  public abstract void zza(ResolveAccountRequest paramResolveAccountRequest, zzw paramzzw)
    throws RemoteException;
  ...
  public abstract void zzce(boolean paramBoolean)
    throws RemoteException;
  
  public abstract void zzxs(int paramInt)
    throws RemoteException;
  ...
  public static abstract class zza
    ...
    implements zze
  {
    public static zze zzki(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      case 2: 
        ...
        zza((AuthAccountRequest)localObject1, zzd.zza.zzkh(paramParcel1.readStrongBinder()));
      ...
      case 5: 
        ...
        zza((ResolveAccountRequest)localObject1, zzw.zza.zzdv(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        return true;
      case 7: 
        paramParcel1.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
        zzxs(paramParcel1.readInt());
        paramParcel2.writeNoException();
        return true;
      case 8: 
        paramParcel1.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
        ...
        zza(paramInt1, (Account)localObject1, zzd.zza.zzkh(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        return true;
      case 9: 
        paramParcel1.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
        localObject1 = zzq.zza.zzdp(paramParcel1.readStrongBinder());
        paramInt1 = paramParcel1.readInt();
        if (paramParcel1.readInt() != 0) {
          bool = true;
        }
      ...
      case 10: 
        ...
        zza((RecordConsentRequest)localObject1, zzd.zza.zzkh(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        return true;
      case 11: 
        paramParcel1.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
        zzb(zzd.zza.zzkh(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        return true;
      }
      paramParcel1.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
      ...
      zza((SignInRequest)localObject1, zzd.zza.zzkh(paramParcel1.readStrongBinder()));
      paramParcel2.writeNoException();
      return true;
    }
      ...
      implements zze
    {
      ...
      public void zza(ResolveAccountRequest paramResolveAccountRequest, zzw paramzzw)
        throws RemoteException
      {
        Parcel localParcel1 = Parcel.obtain();
        Parcel localParcel2 = Parcel.obtain();
        for (;;)
        {
          try
          {
            ...
            if (paramResolveAccountRequest != null)
            {
              ...
              if (paramzzw != null)
              {
                paramResolveAccountRequest = paramzzw.asBinder();
        ...
        throws RemoteException
      {
        ...
        //   58: aload_0
        //   59: getfield 18	com/google/android/gms/signin/internal/zze$zza$zza:zzahn	Landroid/os/IBinder;
        //   62: bipush 9
        //   64: aload 5
        //   66: aload 6
        //   68: iconst_0
        ...
        throws RemoteException
      {
        ...
        //   29: aload_0
        //   30: getfield 18	com/google/android/gms/signin/internal/zze$zza$zza:zzahn	Landroid/os/IBinder;
        //   33: iconst_3
        //   34: aload_2
        //   35: aload_3
        //   36: iconst_0
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/signin/internal/zze$zza$zza:zzahn	Landroid/os/IBinder;
        //   34: bipush 11
        //   36: aload_2
        //   37: aload_3
        //   38: iconst_0
      ...
      public void zzce(boolean paramBoolean)
        throws RemoteException
      {
        int i = 0;
        Parcel localParcel1 = Parcel.obtain();
