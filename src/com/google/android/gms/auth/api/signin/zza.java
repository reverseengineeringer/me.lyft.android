  ...
  implements Parcelable.Creator<GoogleSignInAccount>
{
  static void zza(GoogleSignInAccount paramGoogleSignInAccount, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 8, paramGoogleSignInAccount.zzafl());
    zzb.zza(paramParcel, 9, paramGoogleSignInAccount.zzafm(), false);
    zzb.zzc(paramParcel, 10, cx, false);
  ...
  public GoogleSignInAccount zzas(Parcel paramParcel)
  {
  ...
  public GoogleSignInAccount[] zzda(int paramInt)
  {
