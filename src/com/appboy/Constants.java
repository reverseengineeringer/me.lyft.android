...
public final class Constants
{
  ...
  public static final String APPBOY_LOG_TAG_PREFIX = String.format("%s v%s ", new Object[] { "Appboy", "1.13.4" });
  ...
  public static final String APPBOY_SDK_VERSION = "1.13.4";
...
/* Location:
 * Qualified Name:     com.appboy.Constants
