...
@TargetApi(11)
public class AppboyXamarinFormsFeedFragment
  ...
  implements SwipeRefreshLayout.OnRefreshListener
{
  ...
  private static final String TAG = String.format("%s.%s", new Object[] { Constants.APPBOY_LOG_TAG_PREFIX, AppboyXamarinFormsFeedFragment.class.getName() });
    ...
    for (;;)
    {
      ...
      localListView.setOnScrollListener(new AbsListView.OnScrollListener()
      {
        public void onScroll(AbsListView paramAnonymousAbsListView, int paramAnonymousInt1, int paramAnonymousInt2, int paramAnonymousInt3)
        {
          ...
          AppboyXamarinFormsFeedFragment.access$402(AppboyXamarinFormsFeedFragment.this, paramAnonymousInt3);
          AppboyXamarinFormsFeedFragment.access$602(AppboyXamarinFormsFeedFragment.this, paramAnonymousInt1 + paramAnonymousInt2);
        }
      ...
      mFeedUpdatedSubscriber = new IEventSubscriber()
      {
        public void trigger(final FeedUpdatedEvent paramAnonymousFeedUpdatedEvent)
        {
          ...
          localActivity.runOnUiThread(new Runnable()
          {
            public void run()
            {
              AppboyLogger.d(AppboyXamarinFormsFeedFragment.TAG, "Updating feed views in response to FeedUpdatedEvent: " + paramAnonymousFeedUpdatedEvent);
              ...
              {
                AppboyLogger.i(AppboyXamarinFormsFeedFragment.TAG, String.format("Feed received was older than the max time to live of %d seconds, displaying it for now, but requesting an updated view from the server.", new Object[] { Integer.valueOf(60) }));
                mAppboy.requestFeedRefresh();
                if (paramAnonymousFeedUpdatedEvent.getCardCount(mCategories) != 0) {
                  break;
                }
                AppboyLogger.d(AppboyXamarinFormsFeedFragment.TAG, String.format("Old feed was empty, putting up a network spinner and registering the network error message on a delay of %dms.", new Object[] { Integer.valueOf(5000) }));
...
/* Location:
 * Qualified Name:     com.appboy.ui.AppboyXamarinFormsFeedFragment
