...
class CountdownTimer$CountdownTimerObservable
  implements Observable.OnSubscribe<Integer>
{
  ...
  public CountdownTimer$CountdownTimerObservable(long paramLong, TimeUnit paramTimeUnit, int paramInt)
  {
    timeDelay = paramLong;
...
/* Location:
 * Qualified Name:     com.lyft.rx.CountdownTimer.CountdownTimerObservable
