...
class RxLocationService$6
  implements LocationCallback
{
  RxLocationService$6(RxLocationService paramRxLocationService, Subscriber paramSubscriber) {}
  
  public void onError(String paramString, int paramInt)
  {
    RxLocationService.access$500(this$0).trackFusedLocationError(paramString, paramInt);
  }
  
  public void onLocationChanged(Location paramLocation)
  {
    RxLocationService.access$500(this$0).trackFusedLocationSuccess();
...
/* Location:
 * Qualified Name:     me.lyft.android.infrastructure.location.RxLocationService.6
