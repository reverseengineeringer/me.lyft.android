...
class AndroidContactsProvider$2
  implements Observable.OnSubscribe<UserContact>
{
  AndroidContactsProvider$2(AndroidContactsProvider paramAndroidContactsProvider) {}
  ...
  public void call(Subscriber<? super UserContact> paramSubscriber)
  {
    ...
    try
    {
      Cursor localCursor = this$0.resolver.query(ContactsContract.CommonDataKinds.Phone.CONTENT_URI, new String[] { "display_name", "data1", "data2" }, null, null, "display_name COLLATE NOCASE ASC");
      ...
      for (;;)
      {
        ...
        localObject1 = localCursor;
        localObject2 = localCursor;
        paramSubscriber.onNext(new UserContact(localCursor.getString(i), null, localCursor.getString(j), localCursor.getString(j)));
      }
...
/* Location:
 * Qualified Name:     me.lyft.android.infrastructure.contacts.AndroidContactsProvider.2
