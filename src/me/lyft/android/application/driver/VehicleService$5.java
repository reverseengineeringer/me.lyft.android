...
class VehicleService$5
  implements Func1<VehiclesDTO, Vehicle>
{
  VehicleService$5(VehicleService paramVehicleService, String paramString, File paramFile) {}
  ...
  public Vehicle call(VehiclesDTO paramVehiclesDTO)
  {
    ...
    while (paramVehiclesDTO.hasNext())
    {
      ...
      if (localVehicle.getId().equals(val$vehicleId))
      {
        ...
        VehicleService.access$000(this$0).getInsurance().setPhotoFile(val$insurancePhotoFile);
        return localVehicle;
      }
    }
...
/* Location:
 * Qualified Name:     me.lyft.android.application.driver.VehicleService.5
