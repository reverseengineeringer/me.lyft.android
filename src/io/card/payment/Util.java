...
class Util
{
  ...
  public static String manifestHasConfigChange(ResolveInfo paramResolveInfo, Class paramClass)
  {
    ...
    for (;;)
    {
      ...
      return str;
      if (!hasConfigFlag(activityInfo.configChanges, 128)) {
  ...
  {
    return new Rect(x - paramInt1 / 2, y - paramInt2 / 2, x + paramInt1 / 2, y + paramInt2 / 2);
  }
...
/* Location:
 * Qualified Name:     io.card.payment.Util
