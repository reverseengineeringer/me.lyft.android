...
class Logo
{
  ...
  public Logo(Context paramContext)
  {
  ...
  public void draw(Canvas paramCanvas, float paramFloat1, float paramFloat2)
  {
    ...
    paramCanvas.save();
    float f = mLogo.getHeight() / mLogo.getWidth();
    if (paramFloat2 / paramFloat1 < f)
    {
    ...
    for (;;)
    {
      paramFloat2 /= 2.0F;
      paramFloat1 /= 2.0F;
      paramCanvas.drawBitmap(mLogo, new Rect(0, 0, mLogo.getWidth(), mLogo.getHeight()), new RectF(-paramFloat2, -paramFloat1, paramFloat2, paramFloat1), mPaint);
      paramCanvas.restore();
      return;
