...
class SystemKeyStore
{
  ...
  public SystemKeyStore(InputStream paramInputStream, String paramString)
  {
    ...
    trustRoots = initializeTrustedRoots(paramInputStream);
    trustStore = paramInputStream;
  }
  ...
  {
    X509Certificate localX509Certificate = (X509Certificate)trustRoots.get(paramX509Certificate.getIssuerX500Principal());
    if (localX509Certificate == null) {
      return null;
    }
  ...
  {
    X509Certificate localX509Certificate = (X509Certificate)trustRoots.get(paramX509Certificate.getSubjectX500Principal());
